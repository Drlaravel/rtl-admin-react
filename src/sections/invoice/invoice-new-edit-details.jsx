...
export function InvoiceNewEditDetails() {
  ...
  const renderTotal = (
    ...
    >
      <Stack direction="row">
        <Box sx={{ color: 'text.secondary' }}>زیرمجموعه</Box>
        <Box sx={{ width: 160, typography: 'subtitle2' }}>{fCurrency(subtotal) || '-'}</Box>
      </Stack>

      <Stack direction="row">
        <Box sx={{ color: 'text.secondary' }}>حمل و نقل</Box>
      ...
      <Stack direction="row">
        <Box sx={{ color: 'text.secondary' }}>مالیات‌ها</Box>
