  ...
  const renderFooter = (
    <View style={[styles.container, styles.footer]} fixed>
      <View style={{ width: '75%' }}>
        ...
        <Text>
          از تجارت شما قدردانی می‌کنیم. اگر نیاز به افزودن مالیات بر ارزش افزوده یا یادداشت‌های اضافی دارید، به ما اطلاع دهید!
        </Text>
      </View>
    ...
    <>
      ...
      <View style={styles.table}>
        <View>
          <View style={styles.row}>
            ...
            <View style={[styles.cell_5, { textAlign: 'right' }]}>
              <Text style={styles.subtitle2}>مجموع</Text>
            </View>
          </View>
        </View>
        ...
        <View>
          ...
          {[
            { name: 'جمع کل', value: subtotal },
            { name: 'هزینه ارسال', value: -shipping },
            { name: 'تخفیف', value: -discount },
            { name: 'مالیات', value: taxes },
            { name: 'مجموع', value: totalAmount, styles: styles.h4 },
          ].map((item) => (
