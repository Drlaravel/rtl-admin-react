...
const PAYMENT_OPTIONS = [
  { value: 'paypal', label: 'پی‌پال' },
  { value: 'credit', label: 'کارت اعتباری / دبیت کارت' },
];

const CARD_OPTIONS = [
  { value: 'visa1', label: '**** **** **** 1212 - جیمی هلند' },
  { value: 'visa2', label: '**** **** **** 2424 - شاون استوکس' },
  { value: 'mastercard', label: '**** **** **** 4545 - کول آرمسترانگ' },
];
    ...
    >
      ...
      {isCredit && (
        <Stack spacing={2.5} alignItems="flex-end" sx={{ pt: 2.5 }}>
          <TextField select fullWidth label="کارت‌ها" SelectProps={{ native: true }}>
