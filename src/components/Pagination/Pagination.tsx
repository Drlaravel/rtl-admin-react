...
const Pagination: React.FC<PaginationProps> = ({ pageCount, currentPage, onPageChange }) => {
  ...
  return (
    <div className='my-5 flex cursor-pointer items-center justify-center rounded-md p-1 px-2'>
      ...
      pageLinkClassName={'datatable-pagination-list-item-link  text-white  flex cursor-pointer items-center justify-center rounded-md p-1 px-3 hover:bg-primary hover:text-white'}
