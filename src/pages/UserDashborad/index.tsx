...
import Notfication from './IndexNotfication';
;
...
const Dashboard: React.FC = () => {
    ...
    useEffect(() => {
        ...
        api.get('/user/getstats').then((response) => {
    ...
    return (
        <>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
                ...
                <CardDataStats title="کل پرداخت ها" total={`${new Intl.NumberFormat().format(Number(stats.totalProfit))} تومان `} >
                    <svg
                        className="fill-primary dark:fill-white"
                        width="20"
                        height="22"
                ...
                <CardDataStats title="همه ی پروژه ها" total={`${new Intl.NumberFormat().format(Number(stats.totalProjects))}  `} >
                    <svg
                        className="fill-primary dark:fill-white"
                        width="22"
                        height="22"
