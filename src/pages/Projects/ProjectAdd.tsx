...
const ProjectAdd: React.FC = () => {
  ...
  const [step, setStep] = useState(1); // مدیریت مرحله فعلی
  ...
  const onSubmit = (data: FormData) => {
    if (step < 5) {
      setStep(step + 1); // اگر در مرحله‌ی کمتر از آخر هستید به مرحله‌ی بعد بروید
    } else {
      console.log('Form Data Submitted:', data); // ارسال فرم
    }
  };
              ...
              <>
                ...
                {clientType === 'corporate' && (
                  <div className="w-full my-4.5">
                    <label className="mb-2.5 block text-black dark:text-white">نام شرکت</label>
                    <input
                      type="text"
                    ...
                    <div className="mb-4.5" key={field.id}>
                      ...
                      <div className="mb-4.5">
                        ...
                        <DatePicker
                          ...
                          {...register(`payments.${index}.payment_date`, { required: 'تاریخ پرداخت الزامی است.' })}
                  ...
                  {hostType === 'ours' && (
                    <>
                      ...
                      <div className="mb-4.5">
                        ...
                        <input
                          type="text"
                          {...register('host.host_link', { required: 'لینک هاست الزامی است.' })}
                          className={`w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary ${errors.host?.host_link ? 'border-red-500' : 'border-stroke'}`}
                          placeholder="لینک هاست را وارد کنید"
                        />
                        {errors.host?.host_link && <p className="text-danger text-3 mt-2.5">{errors.host.host_link.message}</p>}
                      </div>
                  ...
                  {hostType === 'customer' && (
                    <>
                      ...
                      <div className="mb-4.5">
                        ...
                        <input
                          type="text"
                          {...register('host.host_space', { required: 'فضای هاست الزامی است.' })}
                          className={`w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary ${errors.host?.host_space ? 'border-red-500' : 'border-stroke'}`}
                          placeholder="فضای هاست را وارد کنید"
                        />
                        {errors.host?.host_space && <p className="text-danger text-3 mt-2.5">{errors.host.host_space.message}</p>}
                      </div>
                      ...
                      <div className="mb-4.5">
                        ...
                        <input
                          type="number"
                          {...register('host.host_price', { required: 'قیمت هاست الزامی است.', valueAsNumber: true })}
                          className={`w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary ${errors.host?.host_price ? 'border-red-500' : 'border-stroke'}`}
                          placeholder="قیمت هاست را وارد کنید"
                        />
                        {errors.host?.host_price && <p className="text-danger text-3 mt-2.5">{errors.host.host_price.message}</p>}
                      </div>
                      ...
                      <div className="mb-4.5">
                        ...
                        <input
                          type="text"
                          {...register('host.host_company_name', { required: 'نام شرکت میزبان الزامی است.' })}
                          className={`w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary ${errors.host?.host_company_name ? 'border-red-500' : 'border-stroke'}`}
                          placeholder="نام شرکت میزبان را وارد کنید"
                        />
                        {errors.host?.host_company_name && <p className="text-danger text-3 mt-2.5">{errors.host.host_company_name.message}</p>}
                      </div>
                    </>
                  )}
                </section>
                ...
                <section className="my-5">
                  ...
                  <div className="mb-4.5">
                    ...
                    >
                      ...
                      <option value="12_months">۱۲ ماه</option>
                    </select>
                  ...
                  {watch('support.duration') === '6_months' && (
                    <div className="mb-4.5">
                  ...
                  {watch('support.duration') === '12_months' && (
                    <div className="mb-4.5">
