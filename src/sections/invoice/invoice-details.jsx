...
export function InvoiceDetails({ invoice }) {
  ...
  const renderTotal = (
    <>
      ...
      <StyledTableRow>
        <TableCell colSpan={3} />
        <TableCell sx={{ color: 'text.secondary' }}>هزینه حمل</TableCell>
      ...
      <StyledTableRow>
        <TableCell colSpan={3} />
        <TableCell sx={{ color: 'text.secondary' }}>مالیات‌ها</TableCell>
        <TableCell width={120}>{fCurrency(invoice?.taxes)}</TableCell>
      </StyledTableRow>

      <StyledTableRow>
        <TableCell colSpan={3} />
        <TableCell sx={{ typography: 'subtitle1' }}>کل مبلغ</TableCell>
    ...
    <Box gap={2} display="flex" alignItems="center" flexWrap="wrap" sx={{ py: 3 }}>
      <div>
        ...
        <Typography variant="body2">
          ما از همکاری شما سپاسگزاریم. در صورتی که نیاز دارید مالیات بر ارزش افزوده یا یادداشت‌های اضافی اضافه کنیم، به ما اطلاع دهید!
        </Typography>
      </div>
